...
**** echo, export, unset
     #+begin_src shell
       ...
       $unset ALL_PROXY
     #+end_src
**** symbolink from icloud
#+begin_src bash
  ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/.emacs.d ~/.emacs.d
  ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/.zshrc ~/.zshrc
  ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Exercism ~/Exercism
  ln -s ~/Library/Mobile\ Documents/com~apple~CloudDocs/ ~/icloud/
  EMACS_USER_DIRECTORY=~/.emacs.d emacs
  ln -s ~/Library/Mobile Documents/com~apple~CloudDocs/.config ~/
  ln -s ~/Library/Mobile Documents/com~apple~CloudDocs/Downloads ~/
  ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Brewfile ~/
  ln -s ~/Library/Mobile\ Documents/com\~apple\~CloudDocs/Min ~/Library/Application\ Support/
#+end_src
*** linux
**** disable lid sleep
...
- [2022-12-09 Fri 11:03] \\
  ...
  - flush-lines ^$ delete blank lines
